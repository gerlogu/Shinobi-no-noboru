...
class onlineLobby extends Phaser.Scene{
    ...
    create(){
        ...
        // this.victoriesText1 = this.add.text(this.width/5, this.height/2.5, "Default text1", {
        //     fontFamily: '"Roboto Condensed"',
        //     fontFamily: '"kouzan_font"',
        //     boundsAlignH: "center",
        //     boundsAlignV: "middle",
        //     color: 'black',
        //     fontSize: 20 });
        // this.victoriesText1.setDepth(8000);

        // this.victoriesText2 = this.add.text(this.width/5, this.height/2.95, "Default text2", {
        //     fontFamily: '"Roboto Condensed"',
        //     fontFamily: '"kouzan_font"',
        //     boundsAlignH: "center",
        //     boundsAlignV: "middle",
        //     color: 'black',
        //     fontSize: 20 });
        // this.victoriesText2.setDepth(8000);
